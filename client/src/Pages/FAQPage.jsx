  ...
  return (
    <div className="container py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center mb-8">
        <HelpCircle className="h-6 w-6 sm:h-8 sm:w-8 mr-3 text-blue-600" />
      ...
      <div className="max-w-3xl mx-auto">
                ...
                <div className="px-4 sm:px-6 py-3 sm:py-4">
                  {section.questions.map((item) => (
                    <div key={item.id} className="mb-4 last:mb-0">
                      ...
                      {/* Answer */}
                      {openQuestion === item.id && (
                        <p className="mt-2 text-gray-600 pl-4 text-sm sm:text-base">
                          {item.answer}
                        </p>
                      )}
                    </div>
        ...
        <div className="mt-8 bg-blue-50 rounded-lg p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <a
              href="/guides"
              className="inline-flex items-center justify-center px-4 py-2 bg-white text-blue-600 rounded-lg hover:bg-gray-50 transition-colors text-sm sm:text-base"
            >
              View Guides
            </a>
          </div>
